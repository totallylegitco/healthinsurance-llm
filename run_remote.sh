...
tar --exclude apex --exclude axolotl --exclude lit-parrot --exclude falcontune --exclude "*.tbz2" --exclude wandb --exclude "results" --exclude="dolly" --exclude "out_*" --exclude "combined-llm-data*" --exclude "generated-llm-data*" --exclude "*_out" --exclude "falcon-7b-instruct-alpaca" --exclude "*_model_*" --exclude "*_out_*" --exclude "apex" --exclude "other" --exclude "storage" --exclude "*/runs/*" --exclude "backup-generated" --exclude "miniconda" -cjf "${target}" . &
tpid=$!
