...
def generate_prompts(imr):
    ...
    prompts = {
        "denial": [f"""The independent medical review findings were {findings} and grounds were {grounds}. Use this information to write the original insurance denial."""],
        "appeal": [f"""The independent medical review findings were {findings} and grounds were {grounds}. Use this information to write the original appeal by the patient."""]
    }
            ...
            for (idx, batch_prompts) in mybatch:
                ...
                for r in local_results:
                    ...
                    if not check_for_bad(response_type, r):
                        ...
                        with open(join(gen_loc, f"{idx}MAGIC{i}{response_type}.txt"), "w") as f:
                            f.write(r)
                    else:
                        print(f"Skipping, found bad data in {r} for rt {response_type}")
