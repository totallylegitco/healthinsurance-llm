...
swaps = {
    ...
    "treatment": [
        ...
        ("\s*The treatment denied was an ", ""),
        ("\s*The treatment denied is ", ""),
        ("\s*the enrollees ", ""),
        ("\s*The treatment denied in this case is ", ""),
        ("\s*The treatment denied in this case was ", ""),
        ("\s*The treatment in this case is ", ""),
        ("\s*The treatment in this case was ", ""),
        ("\s*The treatment was ", ""),
        ("\s*The treatment is ", ""),
        ("^\s*(her|his|their) ", ""),
        ("\s*The treatment denied was authorization and coverage for ", ""),
        ("\s*The treatment denied was ", ""),
        ("  ", " "),
    ],
    "denial": [
